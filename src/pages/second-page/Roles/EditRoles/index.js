...
const AddRoles = () => {
  ...
  const handleSelectAll = (e, parent, setFieldValue, value) => {
    ...
    console.log('Parent state: ', newParentState[parent])
    ...
    const allChildrenFalse = children.every(child => !newParentState[child])
    newParentState[parent] = !allChildrenFalse
    console.log('New parent state: ', newParentState)
                                    ...
                                    control={
                                      <Checkbox
                                        ...
                                        onChange={e => {
                                          ...
                                          params == 'ViewRoles'
                                            ? null
                                            : setFieldValue(`${parent}.${child}`, e.target.checked)

                                          setFieldValue(`${parent}.${child}`, e.target.checked)
                                          tempValues[parent][child] = e.target.checked

                                          let temp = { ...tempValues[parent] }
                                          delete temp[parent]
                                          const allChildrenUnchecked = Object.values(temp).every(item => item === false)
                                          const anyChildrenChecked = Object.values(temp).some(v => v === true)
                                          console.log(anyChildrenChecked, allChildrenUnchecked)
